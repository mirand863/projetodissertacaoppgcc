...
\section{Exemplos de uso de ilustrações e citações}
...
\begin{mapa}[!htb]
	...
	\label{mapa}
	\centering
	\includegraphics[width=1\textwidth]{mapa.eps} \\
	\begin{small}\textbf{Fonte: \citeonline{harley2005nueva}}\end{small}
\end{mapa}
